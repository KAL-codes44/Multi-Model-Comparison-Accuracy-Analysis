...
Linear vs Non-linear boundaries:	                Iris classes are nearly linearly separable, but the versicolor/virginica boundary has slight overlap.
Linear models (Logistic Regression) miss some of these edge cases.
